...
<style type="text/css">body,html{background-colour:#fff; margin:0;padding:0}#uplay_player{position:absolute;width:100%important!;height:100%important!;border:none;overflow:hidden;}</style>
</head>
<body>
